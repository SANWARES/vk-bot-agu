...
class VkKeyboardColor_new(Enum):
...
class VkKeyboardButton_new(Enum):
...
class VkKeyboard_new(object):
    ...
    def add_button(self, label, color=VkKeyboardColor_new.DEFAULT, payload=None):
        ...
        if isinstance(color, VkKeyboardColor_new):
        ...
        button_type = VkKeyboardButton_new.TEXT.value
    ...
    def add_location_button(self, payload=None):
        ...
        button_type = VkKeyboardButton_new.LOCATION.value
    ...
    def add_vkpay_button(self, hash, payload=None):
        ...
        button_type = VkKeyboardButton_new.VKPAY.value
    ...
    def add_vkapps_button(self, app_id, owner_id, label, hash, payload=None):
        ...
        button_type = VkKeyboardButton_new.VKAPPS.value
    ...
    def subscribe_push_message(self, put_id, intent_type, label_name="Подписаться", subscribe_id="0", payload=None):
